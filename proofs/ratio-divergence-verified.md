...
The number of distinct prime factors of a random integer $n$ follows the Erdős-Kac distribution with mean $\ln \ln n$.
...
## 5. Proof of Cesàro Mean Divergence
...
The Cesàro mean $\frac{1}{k} \sum_{i=1}^k \log R_i$ converges to the expectation of the stationary distribution (if it exists) or diverges if the drift is positive.
